					...
					<div class="common-filter">
						...
						<form action="#">
							<ul>
								...
								<li class="filter-list"><input class="pixel-radio" type="radio" id="asus" name="brand"><label for="asus">Asus<span>(14)</span></label></li>
								<li class="filter-list"><input class="pixel-radio" type="radio" id="samsung" name="brand"><label for="samsung">Acer<span>(19)</span></label></li>
								<li class="filter-list"><input class="pixel-radio" type="radio" id="asus" name="brand"><label for="asus">Lenovo<span>(05)</span></label></li>
							</ul>
						</form>
					</div>
					<div class="common-filter">
					...
					<div class="row">
						...
						echo'<div class="col-lg-4 col-md-6">';
							echo'<div class="single-product">';
								...
								echo'<img class="img-fluid" src="img/product/macbook_m1.jpg" alt="">';
								echo'<div class="product-details">';
									echo'<h6>MACBOOK PRO M1 2020</h6>';
										echo'<div class="price">';
										echo'<h6>43.000.000 VND</h6>';
